...
MAP_ERROR_CODE expand_node_position_z(Vector_map* position, const double angle, const double x, const double y, const char* word, bstring line)
{
  bstring current_entry = NULL;
...
MAP_ERROR_CODE expand_node_force_z(Vector_map* force, const double angle, const double fx, const double fy, const char* word, bstring line)
{
  bstring current_entry = NULL;
  int ret = 0;
