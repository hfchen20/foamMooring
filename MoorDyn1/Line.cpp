...
void Line::initialize( double* X )	
{
	...
	{	// otherwise just stretch the nodes between the endpoints linearly and hope for the best
        ...
        // hfchen - 7/31/21
        int uflag = catUshapeSol(ZF,UnstrLen,XF,W,N,snodes, Xl, Zl);
        
        cout << "   *** Use instead catenary solution for a U-shaped line hanging on two supports *** success? " 
             << uflag << endl;
